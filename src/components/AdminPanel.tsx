...
import { CheckCircle, XCircle, Calendar, Clock, User, FileText, Eye } from 'lucide-react';
...
interface Reservation {
  ...
  paymentProof: string;
  paymentProofName?: string; // Yeni eklenen özellik
  paymentProofUrl?: string;  // Yeni eklenen özellik
  submittedAt: string;
}
